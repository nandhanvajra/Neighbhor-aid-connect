const config = {
  ...
  appName: import.meta.env.VITE_APP_NAME || "CommSync",
  ...
  featureCards: [
    {
      ...
      description:
        "Connect with neighbors who can provide assistance with everyday tasks",
      link: "/dashboard",
    },
    {
      key: "volunteer",
      ...
      description:
        "Discover ways to give back and support others in your community",
      link: "/dashboard",
    },
    {
      key: "forums",
      ...
      description:
        "Join discussions and stay informed about local news and events",
      link: "/dashboard",
    },
  ],
  dashboardNavItems: [
